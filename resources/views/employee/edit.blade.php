                ...
                <div class="row">
                    ...
                    <div class="md-form mb-4">
                        ...
                        <select name="roles[]" class="form-control check-custom" multiple>
                            @foreach ($roles as $role)
                                <option value="{{ $role->name }}" @if (in_array($role->id, $old_role)) selected @endif>
                                    {{ $role->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="md-form mb-4">
                        ...
                        <div class="form-control">
                            <input type="file" class="form-control-file pb-10" name="profile_img" id="profile_img"
                                multiple>
                        </div>
                    </div>
                    ...
                    <div class="md-form mb-4">
                        ...
                        <input type="number" name="pin_code" class="form-control password">
                    </div>
                    <div class="md-form mb-4">
